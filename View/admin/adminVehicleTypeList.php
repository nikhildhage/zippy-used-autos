...
<main>
    ...
    <form action="types.php" method="POST">
        ...
        <input type="text" name="type_name" placeholder="Type Name" class="block w-48 mb-3 mt-2 py-1 px-3 border border-gray-300 bg-white rounded shadow focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
